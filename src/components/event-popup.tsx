...
export function EventPopup({ open, onClose, className }: EventPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center px-4 py-10">
      ...
      >
        <button
          type="button"
          onClick={onClose}
          className="absolute right-6 top-6 inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white transition hover:border-white/50 hover:text-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
