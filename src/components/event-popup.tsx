...
export function EventPopup({ open, onClose, className }: EventPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center px-3 py-6 sm:px-4 sm:py-10">
      ...
      <div
        className={cn(
          "relative z-10 w-full max-w-[420px] sm:max-w-3xl lg:max-w-5xl overflow-hidden rounded-[1.5rem] border border-white/15 bg-[rgba(26,0,3,0.92)] shadow-[0_40px_120px_rgba(0,0,0,0.55)]",
          className
        )}
      >
        <button
        ...
        <div className="max-h-[80vh] overflow-y-auto">
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="flex flex-col gap-6 p-6 lg:p-8">
              <div className="rounded-[1.4rem] border border-white/15 bg-[rgba(53,1,4,0.75)] p-6">
                <div className="space-y-3 text-sm text-muted">
                  <div className="flex flex-col gap-3 text-center lg:hidden">
                    <p className="text-xs uppercase tracking-[0.4em] text-gold">{event.subtitle}</p>
